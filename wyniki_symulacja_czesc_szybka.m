function wyniki_symulacja_czesc_szybka()
...
E = 1-G_sz;           %transmitancja uchybowa obiektu bez pêtli sprzê¿enia zwrotnego
...
hold on
step(G_sz/2)
title('Znormalizowana Charakterystyka Skokowa ')
xlabel('Czas')
ylabel('Amplituda')
grid on
